...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/logofavicon.png" rel="icon" sizes="192x192">
...
<body>
  ...
  <header id="header" class="sticky-top">
    <div class="container d-flex align-items-center">
      ...
      <!--<h1 class="logo me-auto"><a href="index.html">PLAN2CAREER</a></h1>-->
      <h1 class="logo me-auto"><a href="/"><img src="assets/img/p2c.png" alt="Logo" class="img-fluid" width="200" height="200"></a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
       <ul>
          ...
          <li><a class="{{'about'==request()->path()?'active':''}}" href="/about">About</a></li>
          <li><a href="#">Tutor</a></li>
          <li><a class="{{'courses'==request()->path() ? 'active' : ''}}" href="/courses">Courses</a></li>
          <li><a class="{{'trainers'==request()->path() ? 'active' : ''}}" href="/trainers">Trainers</a></li>



          <li><a class="{{'contact'==request()->path() ? 'active' : ''}}" href="/contact">Contact</a></li>
          <li><a href="#">Freelancing</a></li>
          <li><a class="{{'login'==request()->path() ? 'active' : ''}}" href="/login">Login</a></li>
          <li><a class="{{'register'==request()->path() ? 'active' : ''}}" href="/register">Register</a></li>
