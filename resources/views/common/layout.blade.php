...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/logo/logo.png" rel="icon" sizes="192x192">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                  <a class="navbar-brand" href="/">
                      <img src="assets/img/logo/logo.png" alt="Logo" class="img-fluid" width="85" height="">
                  </a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link {{'webDevelopment'==request()->path()?'active':''}}" aria-current="page" href="/webDevelopment">Web Development</a></li>
                        <li class="nav-item"><a class="nav-link {{'android'==request()->path()?'active':''}}" aria-current="page" href="/android">Android</a></li>
                        <li class="nav-item"><a class="nav-link {{'digitalMarketing1'==request()->path()?'active':''}}" aria-current="page" href="/digitalMarketing1">Digital Marketing</a></li>
                        <li class="nav-item"><a class="nav-link {{'freelancing'==request()->path()?'active':''}}" aria-current="page" href="/freelancingRegistration">Freelancing</a></li>
                        <li class="nav-item"><a class="nav-link {{'contact'==request()->path()?'active':''}}" aria-current="page" href="/contact">Contact</a></li>
                        
                        
                        
                        <!--<li class="nav-item"><a class="nav-link {{'login'==request()->path()?'active':''}}" aria-current="page" href="/login">Login</a></li>
                        <li class="nav-item"><a class="nav-link {{'register'==request()->path()?'active':''}}" aria-current="page" href="/register">Register</a></li>-->
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
             41 (3rd floor), Ibrahim Mia Road, Shibbari Mor, Khulna, Bangladesh <br><br>
              ...
              <strong>Webs:</strong> www.plan2career.com <br>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="/details">Get Started</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="/commonform">Common Form</a></li>
            </ul>
          </div>
