            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-6 col-md-6 col-sm-6 p-3" style="box-shadow: 0px 0px 10px 0px gray;border-radius: 3%;">
                    <form class="row g-3" method="post" action="/freelancingregistrationprocess">
                        @csrf
                        <h3 class="text-center">Registration Form<hr></h3> 
                        <div class="col-12">
                        ...
                        <div class="col-12">
                              ...
                              <textarea class="form-control rounded-0" id="exampleFormControlTextarea2" rows="3" name="message" type="text"></textarea>
                        </div>
