            ...
            <!--<h1 class="mb-3">Our Others Business</h1>-->
              ...
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 my-3 d-flex justify-content-center" >
                <div class="boxCourses py-4 justify-content-center">
                  ...
                  <h3><a class="" href="{{ url('/commonform') }}">Social Media Marketing</a></h3>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 my-3 d-flex justify-content-center" >
                <div class="boxCourses py-4">
                  ...
                  <h3><a class="" href="{{ url('/commonform') }}">Facebook Marketing</a></h3>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 my-3 d-flex justify-content-center" >
                <div class="boxCourses py-4">
                  ...
                  <h3><a class="" href="{{ url('/commonform') }}">Email Marketing</a></h3>
                </div>
              </div>
              ...
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 my-3 d-flex justify-content-center" >
                <div class="boxCourses py-4">
                  ...
                  <h3><a class="" href="{{ url('/commonform') }}">E-Branding</a></h3>
                </div>
              </div>
