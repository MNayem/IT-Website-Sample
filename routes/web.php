...
Route::get('/mathintermediate', [ChatController::class,'mathintermediate' ]) ;
Route::post('/mathintermediateprocess', [ChatController::class,'mathintermediateprocess' ]) ;
...
Route::get('/englishintermediate', [ChatController::class,'englishintermediate' ]) ;
Route::post('/englishintermediateprocess', [ChatController::class,'englishintermediateprocess' ]) ;

Route::get('/englishadvance', [ChatController::class,'englishadvance' ]) ;
Route::post('/englishadvanceprocess', [ChatController::class,'englishadvanceprocess' ]) ;
...
Route::get('/analyticalintermediate', [ChatController::class,'analyticalintermediate' ]) ;
Route::post('/analyticalintermediateprocess', [ChatController::class,'analyticalintermediateprocess' ]) ;

Route::get('/analyticaladvance', [ChatController::class,'analyticaladvance' ]) ;
Route::post('/analyticaladvanceprocess', [ChatController::class,'analyticaladvanceprocess' ]) ;

//service rout
Route::get('/stockmanagement', [SampleController::class, 'stockmanagement' ]);
Route::get('/ecommerce', [SampleController::class, 'ecommerce' ]);
Route::get('/lms', [SampleController::class, 'lms' ]);
Route::get('/ebranding', [SampleController::class, 'ebranding' ]);
Route::get('/brandpromotion', [SampleController::class, 'brandpromotion' ]);
...
//Common Form
Route::get('/commonform', [CommonController::class,'commonRegistration' ])->name('commonRegistration');
...
Route::get('/courses', [CommonController::class,'courses' ])->name('coursea');
Route::get('/demo', [CommonController::class,'demo' ])->name('demo');
Route::get('/new', [CommonController::class,'new' ])->name('new');

Route::get('/webDevelopment', [CommonController::class,'webDevelopment' ])->name('webDevelopment');
Route::get('/android', [CommonController::class,'android' ])->name('android');
Route::get('/digitalMarketing1', [CommonController::class,'digitalMarketing1' ])->name('digitalMarketing1');
...
Route::get('/softwareFirm', [SampleController::class,'softwareFirm' ])->name('softwareFirm');
Route::get('/digitalMarketing', [SampleController::class,'digitalMarketing' ])->name('digitalMarketing');

Route::get('/food', [SampleController::class,'food' ])->name('food');
Route::get('/electronic', [SampleController::class,'electronic' ])->name('electronic');
Route::get('/superShop', [SampleController::class,'superShop' ])->name('superShop');
Route::get('/restaurent', [SampleController::class,'restaurent' ])->name('restaurent');
Route::get('/multiVendor', [SampleController::class,'multiVendor' ])->name('multiVendor');
Route::get('/stockAdmin', [SampleController::class,'stockAdmin' ])->name('stockAdmin');
Route::get('/accountAdmin', [SampleController::class,'accountAdmin' ])->name('accountAdmin');

Route::get('/onlineCoaching', [SampleController::class,'onlineCoaching' ])->name('onlineCoaching');
Route::get('/udemyTypes', [SampleController::class,'udemyTypes' ])->name('udemyTypes');
Route::get('/consultancy', [SampleController::class,'consultancy' ])->name('consultancy');
Route::get('/university', [SampleController::class,'university' ])->name('university');
Route::get('/tutorBased', [SampleController::class,'tutorBased' ])->name('tutorBased');
...
// Kids Programming Landing Page 

Route::get('/kidsprogramming', function () {
    return view('common.kids');
});
...
Route::view('/vocabulary', 'vocabulary.verb');
