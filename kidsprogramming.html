...
<body>
	<div class="container mt-5">
		<div class="row">
		  <div class="col-7 px-5">
		  	...
		  	<p style="font-family: roboto; font-size: 18px;">Bolster your preparation for the IELTS speaking, listening, writing and reading test with this IELTS preparation course.</p>
				<h3 style="font-size: 34px; font-weight: bold; font-family: roboto;">Instructor</h3>
				<div class="row py-3" id="inner_row1">
					 <div class="col-2 d-flex justify-content-center">
						 <img src="{{URL::asset('/images/instructor.jpg')}}" alt="Instructor Image" class="rounded-circle img-fluid" style="border-radius: 50%; height: 80px; width: 80px;">
					 </div>
					 <div class="col-10">
				...
				<br>
				<h3 style="font-size: 28px; font-weight: bold; font-family: roboto;">এই কোর্সটি থেকে যা শিখবেন</h3>
				<div id="inner_row1">
					<br>
				...
				<br>
				<h3 style="font-size: 28px; font-weight: bold; font-family: roboto;">কোর্সটি কাদের জন্য?</h3>
				<div id="inner_row1">
					<br>
				...
				<br>
				<h3 style="font-size: 28px; font-weight: bold; font-family: roboto;">কোর্সটির বৈশিষ্ট্যগুলো কী কী?</h3>
				<div id="inner_row1">
					<br>
				...
				<br>
				<h3 style="font-size: 28px; font-weight: bold; font-family: roboto;">সুবিধা সমূহ!</h3>
				<div id="inner_row1">
					<br>
				...
				<br>
				<br>
				<h3 style="font-size: 28px; font-weight: bold; font-family: roboto;">কোর্স সিলেবাস</h3>
				<div id="inner_row1">
					<br>
		...
		<br>
		<h3 style="font-size: 22px; font-weight: bold; font-family: roboto;">আপনার জন্য আরো কোর্স</h3><br>
		<div class="row">
		  <div class="col-3">
				<div class="card" style="width: 20rem;">
			  <img class="card-img-top" src="{{URL::asset('/images/1.jpg')}}" alt="Card image cap">
			  <div class="card-body">
		  ...
		  <div class="col-3">
				<div class="card" style="width: 20rem;">
			  <img class="card-img-top" src="{{URL::asset('/images/2.jpg')}}" alt="Card image cap">
			  <div class="card-body">
		  ...
		  <div class="col-3">
				<div class="card" style="width: 20rem;">
			  <img class="card-img-top" src="{{URL::asset('/images/3.jpg')}}" alt="Card image cap">
			  <div class="card-body">
		  ...
		  <div class="col-3">
				<div class="card" style="width: 20rem;">
				<img class="card-img-top" src="{{URL::asset('/images/4.jpg')}}" alt="Card image cap">
				<div class="card-body">
